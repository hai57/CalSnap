...
const VI: Record<string, string> = {
  ...
  'Top bar or side bar.': 'Thanh trên hoặc thanh bên.',
  'Top bar': 'Thanh trên',
  'Side bar': 'Thanh bên',
  ...
  Account: 'Tài khoản',
  Focus: 'Tập trung',
  'Music and tools to help you work.':
    'Nhạc và công cụ giúp bạn làm việc.',
  Music: 'Âm nhạc',
  Spotify: 'Spotify',
  YouTube: 'YouTube',
  'Paste a Spotify or YouTube link': 'Dán link Spotify hoặc YouTube',
  Load: 'Tải',
  'Could not read that link. Try a Spotify or YouTube URL.':
    'Không đọc được link. Thử URL Spotify hoặc YouTube.',
  'Pick a preset or paste a link to start playing.':
    'Chọn preset hoặc dán link để bắt đầu phát.',
  'Your work + music, all in one tab.':
    'Công việc + âm nhạc, gói gọn trong một tab.',
  ...
  'Soundtrack your focus session.': 'Nhạc nền cho phiên tập trung của bạn.',
  'Now playing': 'Đang phát',
  'Pick a station below to start the stream.':
    'Chọn một kênh bên dưới để bắt đầu phát.',
  'Quick stations': 'Kênh nhanh',
  'Stack Overflow search': 'Tìm trên Stack Overflow',
  'e.g. dependency injection scope':
    'vd: phạm vi dependency injection',
  "Opens in a new tab (these sites can't be embedded).":
    'Mở ở tab mới (các trang này không thể nhúng).',
  ...
  'Saved locally': 'Đã lưu trên máy',
  'Name (e.g. Jira)': 'Tên (vd: Jira)',
  Add: 'Thêm',
  'No links yet — add your favourites above.':
    'Chưa có link nào — thêm link yêu thích ở trên.',
  Remove: 'Xóa',
  'To-do': 'Việc cần làm',
  ...
  'Jot down anything — saved to this browser.':
    'Ghi lại bất cứ điều gì — lưu trên trình duyệt này.',
  'Toggle task': 'Đổi trạng thái việc',
  'Delete task': 'Xóa việc',
  'Quick links': 'Liên kết nhanh',
  'Embed a page': 'Nhúng trang web',
  'Paste any link (https://...)': 'Dán bất kỳ link nào (https://...)',
  Embed: 'Nhúng',
  'That does not look like a valid link.': 'Link này có vẻ không hợp lệ.',
  'Open in new tab': 'Mở tab mới',
  'Embedded page': 'Trang đã nhúng',
  'Some sites block embedding. Use "Open in new tab" if blank.':
    'Một số trang chặn nhúng. Dùng "Mở tab mới" nếu trống.',
  'Paste a link to preview the page here.':
    'Dán link để xem trang ở đây.',
  'Click a quick link or paste a URL to open it here.':
    'Bấm một liên kết nhanh hoặc dán URL để mở tại đây.',
  'Focus timer': 'Đồng hồ tập trung',
  'Search source': 'Nguồn tìm kiếm',
  'Search...': 'Tìm kiếm...',
  Search: 'Tìm kiếm',
  Start: 'Bắt đầu',
  Pause: 'Tạm dừng',
